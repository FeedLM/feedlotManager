...
public class IngresoAlimento extends javax.swing.JFrame {

    public IngresoAlimento(java.awt.Frame parent, String numero_lote, Corral corral) {
        //super(parent, modal);
        this.parent = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(t_costoTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, 100, 22));
        ...
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 110, 22));
        ...
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, 110, 22));

        t_costoUnitario.setText("0.00");
        t_costoUnitario.setFocusable(false);
        t_costoUnitario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_costoUnitarioActionPerformed(evt);
            }
        });
        jPanel1.add(t_costoUnitario, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 150, 100, 22));

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(95, 84, 88));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Costo Total:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 110, 22));
        ...
        jPanel1.add(c_fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 120, 100, -1));
