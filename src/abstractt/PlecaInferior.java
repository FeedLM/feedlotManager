 ...
 */
public class PlecaInferior extends JLabel {

    public PlecaInferior() {
    ...
    public void cargar() {
        ...
        this.setText("");
        ImageIcon fot = (ImageIcon) new javax.swing.ImageIcon(getClass().getResource("/resources/pleca inferior.png"));
